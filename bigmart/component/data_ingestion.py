from bigmart.entity.config_entity import DataIngestionConfig
import sys,os
from bigmart.exception import BigmartException
from bigmart.logger import logging
from bigmart.entity.artifact_entity import DataIngestionArtifact
import tarfile
import numpy as np
...
class DataIngestion:
    ...
    def extract_csv_file(self,csv_file_path:str):
        try:
            ...
            with tarfile.open(_file_path) as housing_tgz_file_obj:
